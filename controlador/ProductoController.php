...
if ($_POST['funcion'] == 'buscar') {
    ...
    foreach ($producto->objetos as $objeto) {
        ...
        $json[] = array(
            ...
            'avatar' => '../imagenes/prod/' . $objeto->avatar
...
if ($_POST['funcion'] == 'cambiar_avatar') {
    ...
    if (($_FILES['photo']['type'] == 'image/jpeg') || ($_FILES['photo']['type'] == 'image/png') || ($_FILES['photo']['type'] == 'image/gif')) {
        ...
        $ruta = '../imagenes/prod/' . $nombre;
        move_uploaded_file($_FILES['photo']['tmp_name'], $ruta);
        $producto->cambiar_logo($id, $nombre);

        if ($avatar != '../imagenes/prod/prod_default.png') {
            unlink($avatar);
        }
...
if ($_POST['funcion'] == 'traer_productos') {
    ...
    foreach ($productos as $resultado) {
        ...
        foreach ($producto->objetos as $objeto) {
            if($resultado->cantidad==''){
                ...
                $resultado_cantidad=$resultado->cantidad;
            }
            $subtotal=$objeto->precio*$resultado_cantidad;
            $producto->obtener_stock($objeto->id_producto);
            foreach ($producto->objetos as $obj ) {
                $stock = $obj->total;
            }
 ...
 if ($_POST['funcion'] == 'reporte_productosPDF') {
    ...
    <header>
    <div id="logo">
    <img src="../imagenes/logo_farmacia.png">
    </div>
