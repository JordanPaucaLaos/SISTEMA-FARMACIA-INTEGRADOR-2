...
if($_POST['funcion']=='recuperar'){
    ...
    $fecha= $diassemana[date('w')]." ".date('d')." de ".$meses[date('n')-1]. " del ".date('Y') .' '.date('h:i A');
...
try {
    ...
    $mail->Username   = 'test_integrador2_farmacia@outlook.com';                     //SMTP username
    $mail->Password   = 'integrador2cicloagosto';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('test_integrador2_farmacia@outlook.com', 'Sistema Farmacia');
              ...
              <tr>
                <td valign="top" width="270" style="background:#1f1f1f; text-align:left;">
                  <a href="#" style="text-decoration:none;">
                    <img src="https://i.pinimg.com/originals/81/23/75/812375de02c133201bee310319b29ae9.jpg" width="50" height="50" alt="Your Logo"/>
                  </a>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 30px">
                  ...
                  <h1>Farmacia Universal<br></h1>
                  <h3> Centro de recuperación de contraseñas</h3>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                    <tr>
                      <td style="width:130px;background:#D84A38;">
                        <div>
                        <a href="http://localhost/sistema_farmacia/index.php"
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                     <td style="font-size:12px; padding-top:5px; text-align:center; padding-right:20px">
                       Usuario: <a style="color:#FA1414; font-size: 20px;">'.$dni.'</a>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  ...
                  * Si el problema persiste pongase en contacto con el administrador del sistema.
                  <br><br>
                  Atentamente. <strong>Centro de recuperacion de contraseñas</strong><br>
                  '.$fecha.'
                  <br>
                </td>
              </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;color:#ffffff" bgcolor="#1f1f1f" >
              <tr>
                <td align="right" valign="middle" class="mobile-padding" style="font-size:12px;padding:20px; background-color:#1f1f1f; color:#ffffff; text-align:left; ">
                  <h4 style="color:#ffffff;"  href="#">&copy; Copyright Farmacia Universal | 2021</h4>
