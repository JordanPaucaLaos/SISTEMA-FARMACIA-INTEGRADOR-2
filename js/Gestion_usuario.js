$(document).ready(function() {
        ...
        $.post('../controlador/UsuarioController.php', { consulta, funcion }, (response) => {
            ...
            usuarios.forEach(usuario => {
                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                      <div class="col-7">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-glass-cheers"></i></span> Edad:${usuario.edad}</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-map-marked-alt"></i></span> Distrito:${usuario.residencia}</li>
                ...
                if (tipo_usuario == 3) {
                    if (usuario.tipo_usuario != 3) {
                        template += `
                        <button class="borrar-usuario btn btn-outline-danger mr-1" type="button" data-toggle="modal" data-target="#confirmar">
                    ...
                    if (usuario.tipo_usuario == 2) {
                        template += `
                        <button class="ascender btn btn-outline-primary ml-1" type="button" data-toggle="modal" data-target="#confirmar">
                      <i class="fas fa-hand-point-up mr-1"></i>Ascender
                      </button>
                        `;
                    ...
                    if (usuario.tipo_usuario == 1) {
                        template += `
                      <button class="descender btn btn-outline-secondary ml-1" type="button" data-toggle="modal" data-target="#confirmar">
                    <i class="fas fa-hand-point-down mr-1"></i>Descender
                    </button>
                      `;
    ...
    $('#form-crear').submit(e => {
        ...
        //evita refrescar la pagina debido al submit
        e.preventDefault();
