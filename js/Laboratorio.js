    ...
    function buscar_lab(consulta) {
        ...
        $.post('../controlador/LaboratorioController.php', { consulta, funcion }, (response) => {
            ...
            laboratorios.forEach(laboratorio => {
                ...
                <td>
                <button class="avatar btn btn-warning" title="cambiar logo de laboratorio" type="button" data-toggle="modal" data-target="#cambiologo"><i class="far fa-image"></i></button>
                ...
                <td><i class="fas fa-flask m-2"></i>${laboratorio.nombre}</td>
