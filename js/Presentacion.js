    ...
    function buscar_pre(consulta) {
        ...
        $.post('../controlador/PresentacionController.php', { consulta, funcion }, (response) => {
            ...
            presentaciones.forEach(presentacion => {
                ...
                <td>
                <button class="editar-pre btn btn-success" title="editar presentacion" type="button" data-toggle="modal" data-target="#crearpresentacion"><i class="fas fa-pencil-alt"></i></button>
                <button class="borrar-pre btn btn-danger" title="borrar presentacion"><i class="fas fa-trash"></i></button>
                
                </td>
                
                <td><i class="fas fa-flask m-2"></i>${presentacion.nombre}</td>
            ...
            if (result.isConfirmed) {
                $.post('../controlador/PresentacionController.php', { id, funcion }, (response) => {
                    ...
                    if (response == 'borrado') {
                        ...
                        swalWithBootstrapButtons.fire(
                            'No se pudo borrar!',
                            'La presentacion ' + nombre + ' no fue borrada porque esta siendo usada en un producto',
                            'error'
                        )
