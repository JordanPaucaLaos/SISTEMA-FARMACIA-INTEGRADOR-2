...
function getHTML($id_venta){
    ...
    <header class="clearfix">
      <div id="logo">
        <img src="../imagenes/logo_farmacia.png" width="280" height="100">
      </div>
      <h1>COMPROBANTE DE PAGO</h1>
      <div id="company" class="clearfix">
        <div id="negocio">Farmacia Universal</div>
        <div>Direccion Numero ###,<br /> Lima, La Victoria</div>
        <div>(344) 342234</div>
        <div class="email"><a href="mailto:funiversal@funiversal.com">funiversal@funiversal.com</a></div>
      </div>';
