...
?>
    <title>FARMACIA | Crear compra</title>
    <?php
                    ...
                    <div class="card p-3">
                      ...
                      <div class="alert alert-danger text-center" id="noadd-prod" style='display:none;'>
                        ...
                        <div class="form-group">
                            ...
                            <input id="cantidad"type="number" class="form-control" value='1' placeholder="Ingrese cantidad" style="width: 30%;" required>
                        </div>
                        <div class="form-group ">
                            <label for="vencimiento">Vencimiento: </label>
                            <input id="vencimiento"type="date" class="form-control" placeholder="Ingrese vencimiento" style="width: 30%;" required>
                        </div>
                        <div class="form-group">
                            <label for="precio_compra">Precio de compra</label>
                            <input id="precio_compra"type="number" step="any" class="form-control" value='1' placeholder="Ingrese precio de compra" style="width: 30%;" required>
                        </div>
