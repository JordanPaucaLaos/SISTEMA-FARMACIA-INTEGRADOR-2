...
?>
    ...
    <title>Farmacia Universal | Compra</title>
  <?php
            ...
            <div class="col-md-12">
                <div class="card card-success">
                    ...
                    <div class="card-body p-0">
                        <header>
                            <div class="logo_cp">
                                <img src="../imagenes/compra-logo.png" width="120" height="120">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card card-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="info-box mb-3 bg-info" style="display: none;">
                                                <span class="info-box-icon"><i class="fas fa-tag"></i></span>
                                                <div class="info-box-content">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-default">
                                        ...
                                        <div class="card-body">
                                            <div class="info-box mb-3 bg-danger" style="display: none;">
