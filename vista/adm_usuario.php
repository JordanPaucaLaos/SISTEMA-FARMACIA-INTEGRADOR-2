                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-danger text-center" id="noadd" style="display:none;">
                            <span><i class="fas fa-times m-1"></i>El dni ya esta registrado</span>
                        </div>
                        <form id="form-crear">
                            ...
                            <div class="form-group">
                                <label for="edad">F. Nacimiento</label>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion Usuarios <button id="button-crear" type="button" data-toggle="modal" data-target="#crearusuario" class="btn bg-gradient-primary ml-2">
                                Crear Usuario
                            </button></h1>
