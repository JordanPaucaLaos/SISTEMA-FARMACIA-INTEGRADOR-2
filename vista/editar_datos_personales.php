...
?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger text-center" id="noupdate" style="display:none;">
                        <span><i class="fas fa-times m-1"></i>La contraseña es erronea</span>
                    </div>
    ...
    <!-- Modal 2 -->
    <div class="animate__animated animate__fadeInLeft modal fade" id="cambiophoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img id="avatar2" src="../imagenes/avatar.png" class="profile-user-img img-fluid img-circle">
                                    </div>
                                    ...
                                    <ul class="list-group list-group-unbordered mb-3">
                                        ...
                                        <button type="button" class="btn btn-block btn-outline-warning btn-sm" data-toggle="modal" data-target="#cambiocontra">
                                            Cambiar Contraseña
                                        </button>
                            ...
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <strong style="color:#076CED">
                                        <i class="fas fa-map-marker-alt mr-2"></i>Direccion
                                    </strong>
                                ...
                                <div class="card-footer">
                                    <p class="text-muted">
                                        <i class="fas fa-mouse-pointer mr-2"></i>Click en el boton si desea editar
                                    </p>
                                </div>
                        ...
                        <div class="col-md-9">
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form-usuario" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="adicional" cols="60" rows="8"></textarea>
                                            </div>
                                ...
                                <div class="card-footer">
                                    <p class="text-muted">
                                        Cuidado con ingresar datos erroneos
                                    </p>
