<?php
session_start();
if ($_SESSION['us_tipo'] == 3 || $_SESSION['us_tipo'] == 2 || $_SESSION['us_tipo'] == 1) {
    include_once 'layouts/header.php';
?>
<title>Farmacia | Gestion Ventas</title>
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <div class="float-right input-group-append">
                            <h3 class="m-3"><i class="fas fa-coins mr-2"></i>Total: </h3>
        ...
        <section>
            ...
            <div class="container-fluid">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                    <table id="tabla_venta" class="table table-hover text-nowrap display responsive nowrap" style="width:100%">
        <thead>
            <tr>
                <th>Codigo</th>
                <th>Fecha</th>
