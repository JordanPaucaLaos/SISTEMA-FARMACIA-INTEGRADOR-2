...
?>
    <title>FARMACIA | Gestion Compras</title>
    <?php
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion compras <a href="adm_ingresar_compra.php" class="btn bg-gradient-success ml-2">Ingresar compra</a></h1>
        ...
        <section>
            ...
            <div class="container-fluid">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <table id="compras" class="table table-dark table-hover display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>ID | Codigo</th>
